...
let mediaJSON = {
  'categories': [{
    ...
    'videos': [{
      ...
      'sources': ['//commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4'],
    ...
    },
    {
      ...
      'sources': ['//commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4'],
    ...
    },
    {
      ...
      'sources': ['//commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4'],
    ...
    },
    {
      ...
      'sources': ['//commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4'],
    ...
    },
    {
      ...
      'sources': ['//commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4'],
    ...
    },
    {
      ...
      'sources': ['//commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4'],
    ...
    },
    {
      ...
      'sources': ['//commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4'],
    ...
    },
    {
      ...
      'sources': ['//commondatastorage.googleapis.com/gtv-videos-bucket/sample/Sintel.mp4'],
    ...
    },
    {
      ...
      'sources': ['//commondatastorage.googleapis.com/gtv-videos-bucket/sample/SubaruOutbackOnStreetAndDirt.mp4'],
      'thumb': 'images/SubaruOutbackOnStreetAndDirt.jpg',
      'title': 'Subaru Outback On Street And Dirt',
      'duration': 594
    },
    {
      'subtitle': 'Tears of Steel was realized with crowd-funding by users of the open source 3D creation tool Blender. Target was to improve and test a complete open and free pipeline for visual effects in film - and to make a compelling sci-fi film in Amsterdam, the Netherlands.  The film itself, and all raw material used for making it, have been released under the Creatieve Commons 3.0 Attribution license. Visit the tearsofsteel.org website to find out more about this, or to purchase the 4-DVD box with a lot of extras.  (CC) Blender Foundation - //www.tearsofsteel.org',
      'sources': ['//commondatastorage.googleapis.com/gtv-videos-bucket/sample/TearsOfSteel.mp4'],
    ...
    },
    {
      ...
      'sources': ['//commondatastorage.googleapis.com/gtv-videos-bucket/sample/VolkswagenGTIReview.mp4'],
    ...
    },
    {
      ...
      'sources': ['//commondatastorage.googleapis.com/gtv-videos-bucket/sample/WeAreGoingOnBullrun.mp4'],
    ...
    },
    {
      ...
      'sources': ['//commondatastorage.googleapis.com/gtv-videos-bucket/sample/WhatCarCanYouGetForAGrand.mp4'],
